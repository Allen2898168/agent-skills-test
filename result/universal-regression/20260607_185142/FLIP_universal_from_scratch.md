...
- generatedAt: `2026-06-07T16:51:42.732Z`
...
## 关键输出
- activityAlias: `flipr51095189`
- activityId: `10040`
- cleanup: `true`
- endTime: `2026-07-08 00:53:15`
- ok: `true`
- startTime: `2026-06-08 00:53:15`
...
[
  {
    "id": "1446",
    "alias": "VIRTUAL-FLIP_CARD-084614",
    "subtype": "FLIP_CARD",
    "name": "虚拟积分或资格-小丑牌-抽牌次数"
  },
  {
    "id": "1447",
    "alias": "VIRTUAL-FLIP_INTEGRAL-084614",
  ...
  - verify: ```json
{
  ...
  "checks": {
    ...
    "applyConfigId": 3559,
    "flipsCount": 1,
    "cardTaskIdFromDetail": 7036,
    "integralTaskIdFromDetail": 7037,
    "prizeIdFromDetail": 1445
  }
}
```
...
```json
{
  "plan": {
    ...
    "activityType": "FLIP",
    "window": {
      "start": "2026-06-08 00:53:15",
      "end": "2026-07-08 00:53:15"
    },
    "writes": {
      "create": true,
      "online": true,
  ...
  "created": {
    "registerTemplateId": "3559",
    "applyConfigId": "3559",
    "giftCashPrizeId": "1445",
    "virtualFlipCardPrizeId": "1446",
    "virtualFlipIntegralPrizeId": "1447",
    "cardTaskId": "7036",
    "integralTaskId": "7037",
    "activityId": "10040",
    "activityAlias": "flipr51095189",
    "activityTitle": "小丑牌通用回归165135"
  },
  "cleanup": {
    "offline": {
      "ok": false,
