...
- generatedAt: `2026-06-07T17:51:31.817Z`
...
## 关键输出
- activityAlias: `flipr54684562`
- activityId: `10078`
- cleanup: `true`
- endTime: `2026-07-08 01:53:07`
- ok: `true`
- startTime: `2026-06-08 01:53:07`
...
[
  {
    "id": "1498",
    "alias": "VIRTUAL-FLIP_CARD-674330",
    "subtype": "FLIP_CARD",
    "name": "虚拟积分或资格-小丑牌-抽牌次数"
  },
  {
    "id": "1499",
    "alias": "VIRTUAL-FLIP_INTEGRAL-674330",
  ...
  - verify: ```json
{
  ...
  "checks": {
    ...
    "applyConfigId": 3618,
    "flipsCount": 1,
    "cardTaskIdFromDetail": 7097,
    "integralTaskIdFromDetail": 7098,
    "prizeIdFromDetail": 1497
  }
}
```
...
```json
{
  "plan": {
    ...
    "activityType": "FLIP",
    "window": {
      "start": "2026-06-08 01:53:07",
      "end": "2026-07-08 01:53:07"
    },
    "writes": {
      "create": true,
      "online": true,
  ...
  "created": {
    "registerTemplateId": "3618",
    "applyConfigId": "3618",
    "giftCashPrizeId": "1497",
    "virtualFlipCardPrizeId": "1498",
    "virtualFlipIntegralPrizeId": "1499",
    "cardTaskId": "7097",
    "integralTaskId": "7098",
    "activityId": "10078",
    "activityAlias": "flipr54684562",
    "activityTitle": "小丑牌通用回归175124"
  },
  "cleanup": {
    "offline": {
      "ok": false,
