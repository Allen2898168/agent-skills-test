...
- generatedAt: `2026-06-07T18:13:23.209Z`
...
## 关键输出
- activityAlias: `flipr55996429`
- activityId: `10092`
- cleanup: `true`
- endTime: `2026-07-08 02:14:58`
- ok: `true`
- startTime: `2026-06-08 02:14:58`
...
[
  {
    "id": "1515",
    "alias": "VIRTUAL-FLIP_CARD-985908",
    "subtype": "FLIP_CARD",
    "name": "虚拟积分或资格-小丑牌-抽牌次数"
  },
  {
    "id": "1516",
    "alias": "VIRTUAL-FLIP_INTEGRAL-985908",
  ...
  - verify: ```json
{
  ...
  "checks": {
    ...
    "applyConfigId": 3631,
    "flipsCount": 1,
    "cardTaskIdFromDetail": 7113,
    "integralTaskIdFromDetail": 7114,
    "prizeIdFromDetail": 1514
  }
}
```
...
```json
{
  "plan": {
    ...
    "activityType": "FLIP",
    "window": {
      "start": "2026-06-08 02:14:58",
      "end": "2026-07-08 02:14:58"
    },
    "writes": {
      "create": true,
      "online": true,
  ...
  "created": {
    "registerTemplateId": "3631",
    "applyConfigId": "3631",
    "giftCashPrizeId": "1514",
    "virtualFlipCardPrizeId": "1515",
    "virtualFlipIntegralPrizeId": "1516",
    "cardTaskId": "7113",
    "integralTaskId": "7114",
    "activityId": "10092",
    "activityAlias": "flipr55996429",
    "activityTitle": "小丑牌通用回归181316"
  },
  "cleanup": {
    "offline": {
      "ok": false,
