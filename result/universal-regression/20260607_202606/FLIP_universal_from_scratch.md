...
- generatedAt: `2026-06-07T18:26:06.648Z`
...
## 关键输出
- activityAlias: `flipr56759580`
- activityId: `10105`
- cleanup: `true`
- endTime: `2026-07-08 02:27:42`
- ok: `true`
- startTime: `2026-06-08 02:27:42`
...
[
  {
    "id": "1537",
    "alias": "VIRTUAL-FLIP_CARD-749245",
    "subtype": "FLIP_CARD",
    "name": "虚拟积分或资格-小丑牌-抽牌次数"
  },
  {
    "id": "1538",
    "alias": "VIRTUAL-FLIP_INTEGRAL-749245",
  ...
  - verify: ```json
{
  ...
  "checks": {
    ...
    "applyConfigId": 3645,
    "flipsCount": 1,
    "cardTaskIdFromDetail": 7130,
    "integralTaskIdFromDetail": 7131,
    "prizeIdFromDetail": 1536
  }
}
```
...
```json
{
  "plan": {
    ...
    "activityType": "FLIP",
    "window": {
      "start": "2026-06-08 02:27:42",
      "end": "2026-07-08 02:27:42"
    },
    "writes": {
      "create": true,
      "online": true,
  ...
  "created": {
    "registerTemplateId": "3645",
    "applyConfigId": "3645",
    "giftCashPrizeId": "1536",
    "virtualFlipCardPrizeId": "1537",
    "virtualFlipIntegralPrizeId": "1538",
    "cardTaskId": "7130",
    "integralTaskId": "7131",
    "activityId": "10105",
    "activityAlias": "flipr56759580",
    "activityTitle": "小丑牌通用回归182559"
  },
  "cleanup": {
    "offline": {
      "ok": false,
