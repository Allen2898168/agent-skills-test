...
- generatedAt: `2026-05-31T19:24:54.082Z`
...
## 关键输出
- activityAlias: `flipr55487018`
- activityId: `9881`
- cleanup: `true`
- endTime: `2026-07-01 03:26:30`
- ok: `true`
- startTime: `2026-06-01 03:26:30`
...
[
  {
    "id": "1309",
    "alias": "VIRTUAL-FLIP_CARD-477335",
    "subtype": "FLIP_CARD",
    "name": "虚拟积分或资格-小丑牌-抽牌次数"
  },
  {
    "id": "1310",
    "alias": "VIRTUAL-FLIP_INTEGRAL-477335",
  ...
  - verify: ```json
{
  ...
  "checks": {
    ...
    "applyConfigId": 3489,
    "flipsCount": 1,
    "cardTaskIdFromDetail": 6442,
    "integralTaskIdFromDetail": 6443,
    "prizeIdFromDetail": 1308
  }
}
```
...
```json
{
  "plan": {
    ...
    "activityType": "FLIP",
    "window": {
      "start": "2026-06-01 03:26:30",
      "end": "2026-07-01 03:26:30"
    },
    "writes": {
      "create": true,
      "online": true,
  ...
  "created": {
    "registerTemplateId": "3489",
    "applyConfigId": "3489",
    "giftCashPrizeId": "1308",
    "virtualFlipCardPrizeId": "1309",
    "virtualFlipIntegralPrizeId": "1310",
    "cardTaskId": "6442",
    "integralTaskId": "6443",
    "activityId": "9881",
    "activityAlias": "flipr55487018",
    "activityTitle": "小丑牌通用回归192447"
  },
  "cleanup": {
    "offline": {
      "ok": false,
