...
5. Cache scripts must not print secrets, tokens, cookies, or private user data.
...
- required runtime config lives in `skills/weex-frontend-ops/.env.local` or `WEEX_FRONTEND_*` environment variables.
